...
# Coordinates of KGISL and destinations
kgisl_coords = [11.0183, 76.9743]
priyabharathi_coords = [11.0261, 77.0195]
gandhipuram_coords = [10.9986, 76.9676]

# Create a Folium map centered at KGISL
mymap = folium.Map(location=kgisl_coords, zoom_start=12)

# Add markers for each location
folium.Marker(kgisl_coords, popup="KGISL").add_to(mymap)
folium.Marker(priyabharathi_coords, popup="Priyabharathi House").add_to(mymap)
folium.Marker(gandhipuram_coords, popup="Gandhipuram").add_to(mymap)

# Create an HTML template with Leaflet Routing Machine integration
html_template = f"""
<!DOCTYPE html>
<html lang="en">
<head>
...
with open('bus_route_tracking.html', 'w') as f:
    f.write(html_template)

# Output message
print("HTML file generated: bus_route_tracking.html")
